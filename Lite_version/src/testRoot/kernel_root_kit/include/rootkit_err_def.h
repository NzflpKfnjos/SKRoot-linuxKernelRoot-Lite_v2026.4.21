...
X(ERR_KPM_BAD_PATH,) \
X(ERR_KPM_NOT_ELF64,) \
X(ERR_KPM_NOT_AARCH64,) \
X(ERR_KPM_NOT_REL,) \
X(ERR_KPM_MISSING_INFO,) \
X(ERR_KPM_MISSING_INIT,) \
X(ERR_KPM_NO_LOADER,) \
X(ERR_KPM_LOAD_FAILED,) \
X(ERR_KPM_UNLOAD_FAILED,) \
X(ERR_KPM_UNSAFE_ARG,) \
X(ERR_SKROOT_KPM_NOT_FOUND,) \
X(ERR_SKROOT_KPM_NO_RUNTIME,) \
X(ERR_SKROOT_KPM_LOAD_FAILED,) \
X(ERR_SKROOT_KPM_MMAP_FAILED,)
